 ...
 * 14/02/2017
 * Captures an image from an OV7670 camera with FIFO memory.
 ***/
...
const byte ChipSelect    = 53;  // default for Arduino Mega
...
// Night mode
#define COM11  0x3B
#define COM11_VALUE_NIGHTMODE_ON        0x80
...
void captureOV7670Frame()
{
  ...
  // 3. Set FIFO wrute enable to active (HIGH) so that the image can be
  //    written to memory.
