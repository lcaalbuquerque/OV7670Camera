/***
 * OV7670ImageCaptureToTFT
 * Luiz C. A. Albuquerque
 * lcaalbuquerque@uol.com.br
 * 11/03/2017
 * Captures an image from an OV7670 camera with FIFO memory to a TFT LCD.
 ***/
...
void executeCommand(String command, bool show = false);
...
void executeCommand(String command, bool show)
{
