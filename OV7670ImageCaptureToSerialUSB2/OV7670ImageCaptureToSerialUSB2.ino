/***
 * OV7670ImageCaptureToSerialUSB2
 * Luiz C. A. Albuquerque
 * lcaalbuquerque@uol.com.br
 * 02/04/2017
 * Captures an image from an OV7670 camera with FIFO memory to the Serial USB
 * on Arduino Due without a TFT LCD.
 ***/
...
const byte HardwareSSPin = 53;  // for Arduino Mega/Due
...
void setup()
{
  ...
  Serial.println(F("Waiting for Serial USB responding..."));
  while (!SerialUSB);
...
byte convertPinValueToByteValue(int pinValue, int pinPosition)
{
  ...
  */
  return pinValue ? 0x01 << pinPosition : 0;
...
void sendTransmitCapturedFrame()
{
  ...
  for (int byteno = 0; byteno < PHOTO_BYTES_PER_PIXEL; byteno++)
  {
    ...
    pixelData = pinVal7 | pinVal6 | pinVal5 | pinVal4 | pinVal3 | pinVal2 |
                pinVal1 | pinVal0;
    /////////////////////////// Serial Line ////////////////////////////////
    byteCounter += SerialUSB.write(pixelData);
    ////////////////////////////////////////////////////////////////////
  }
